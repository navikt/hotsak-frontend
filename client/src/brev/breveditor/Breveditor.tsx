      ...
      >
        <div ref={editorWidthScaleRef} className="breveditor-container" style={{ position: 'relative' }}>
          ...
          <Button
            ...
            variant="tertiary"
            onClick={() => {
              if (!state.current?.valueAsHtml) return
              const blob = new Blob([state.current.valueAsHtml], { type: 'text/html' })
