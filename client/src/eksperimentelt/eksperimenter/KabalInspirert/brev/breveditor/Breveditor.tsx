...
const Breveditor = ({
  ...
  useLayoutEffect(() => {
    ...
    const resizeObserver = new ResizeObserver(() => {
      const { width: actualWidth } = element.getBoundingClientRect()
      let designedWidth = 794 // 595pt in px
      if (!visMarger) designedWidth = 650 // 595pt - 108pt ((64-10)*2=108)
      const scale = actualWidth / designedWidth
      ...
      >
        <div className="breveditor-container">
          ...
          <div className="scrollable-pit">
            <div ref={editorContainerRef} className={!visMarger ? 'scrollable-content zoomed' : 'scrollable-content'}>
              <div
