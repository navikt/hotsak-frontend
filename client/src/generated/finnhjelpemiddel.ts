...
export type HMDBHentProdukterQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', hmsArtNr?: string | null, productVariantURL: string, isoCategoryTitle?: string | null, articleName: string, agreements: Array<{ __typename?: 'AgreementInfoDoc', postTitle?: string | null }> }> };
