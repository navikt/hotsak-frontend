...
export function EnhetensOppgaver() {
  const { oppgaver, totalElements, isLoading, lastInnFlere } = useEnhetensOppgaver(30)
  return (
    <>
      <Box margin="5">
        ...
        <HStack align="center" gap="3" justify="center" marginBlock="5">
          <Button size="small" type="button" variant="secondary" loading={isLoading} onClick={lastInnFlere}>
            Last inn flere
          </Button>
