...
import { Box, Button, ExpansionCard, FormSummary, HStack, Tag, VStack } from '@navikt/ds-react'
...
import classes from './HjelpemiddelV2BoxTest.module.css'
  ...
  return (
    <>
      <ExpansionCard size="small" aria-label="Hjelpemiddel" className={classes.box} defaultOpen={true}>
        ...
        <ExpansionCard.Content className={classes.content}>
          <HjelpemiddelInfo />
