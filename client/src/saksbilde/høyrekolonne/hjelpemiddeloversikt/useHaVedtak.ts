...
import { HaVedtak, HjelpemiddelArtikkel, Vedtaksgrunnlag, VedtaksgrunnlagType } from '../../../types/types.internal'

export interface UseHaVedtakResponse {
  haVedtak: HaVedtak
  error?: HttpError
  isLoading: boolean
...
export function useHaVedtak(fnr?: string, vedtaksgrunnlag?: Vedtaksgrunnlag[]): UseHaVedtakResponse {
